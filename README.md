...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytask-latex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12125&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytask-latex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytask-latex` can be installed with:

```
conda install pytask-latex
```

It is possible to list all of the versions of `pytask-latex` available on your platform with:
